...
/* =========================================
DESTAQUE DO BOTÃO ATIVO (INÍCIO)
========================================= */

function destacarBotaoAtivo() {
    const botaoInicio = document.querySelector('.nav-btn.inicio-btn');
    if (!botaoInicio) return;

    const caminho = window.location.pathname;
    const isIndex = caminho === '/' || 
    ...
    if (isIndex) {
        ...
        botaoInicio.classList.remove('active');
    }
}